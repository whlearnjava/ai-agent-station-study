...
import static cn.bugstack.ai.domain.agent.model.valobj.AiAgentEnumVO.AI_CLIENT_TOOL_MCP;
...
public class AgentRepository implements IAgentRepository {
    ...
    public Map<String, AiClientSystemPromptVO> queryAiClientSystemPromptMapByClientIds(List<String> clientIdList){
        List<AiClientSystemPromptVO> aiClientSystemPrompt = AiClientSystemPromptVOByClientIds(clientIdList);

        if(aiClientSystemPrompt==null||aiClientSystemPrompt.isEmpty()){
            return Collections.emptyMap();
        }
        return aiClientSystemPrompt.stream()
    ...
    public Map<String, AiAgentClientFlowConfigVO> queryAiAgentClientFlowConfig(String aiAgentId) {
        ...
        for(AiAgentFlowConfig aiAgentFlowConfig : aiAgentFlowConfigs) {
            AiAgentClientFlowConfigVO flowConfigVO = AiAgentClientFlowConfigVO.builder()
                    .clientId(aiAgentFlowConfig.getClientId())
                    .clientName(aiAgentFlowConfig.getClientName())
                    .clientType(aiAgentFlowConfig.getClientType())
                    .sequence(aiAgentFlowConfig.getSequence())
                    .build();
            result.put(aiAgentFlowConfig.getClientType(), flowConfigVO);
