 ...
 *
 *
 * bce-v3/ALTAK-nX3hWOIBMplWfDSxKWakV/e1aa0c4d7c0503a5ceb345370c8c64b21d483ec4
 */
            ...
            OpenAiApi openAiApi = OpenAiApi.builder()
             ...
             chatModel = OpenAiChatModel.builder()
                    ...
                    .defaultOptions(OpenAiChatOptions.builder()
                            .model("gpt-4.1-mini")
                            .toolCallbacks(new SyncMcpToolCallbackProvider(sseMcpClient(),computerMcpClient(),stdioMcpClient()).getToolCallbacks())
                            .build()).build();
...
//                                .build()),
        ...
        if (!isCompleted) {
            ...
            String summaryPrompt = String.format("""
                    ...
                    **文件生成:**
                    在 D:\\文件 目录下创建对应的MD文档，文档名分别为：springboot-basics.md,将总结写进md文档
    ...
    // MCP 客户端配置方法
    public McpSyncClient computerMcpClient() {
        // 使用 mcp-server-computer 服务器的配置
        var stdioParams = ServerParameters.builder("java")
                .args("-Dspring.ai.mcp.server.stdio=true",
                        "-jar",
                        "D:\\MavenProject\\AIAgent\\mcp-server-computer-master\\mcp-server-computer-master\\target\\mcp-server-computer-1.0.0.jar")
                .build();
        ...
        try {
            ...
            log.info("Computer MCP Initialized: {}", init);
        } catch (Exception e) {
            log.error("Failed to initialize Computer MCP client", e);
        }
    ...
    public McpSyncClient stdioMcpClient_weixin() {
        // 使用 filesystem 服务器的配置
        var stdioParams = ServerParameters.builder("java")
                .args( "-Dspring.ai.mcp.server.stdio=true",
                        "-jar",
                        "D:\\MavenProject\\AIAgent\\mcp-server-weixin-15-weixin-notice-service (1)\\mcp-server-weixin-15-weixin-notice-service\\target\\mcp-server-weixin-1.0.0.jar"
                )
                .build();
    ...
    public void test_aiClientApiNode() throws Exception {
        ...
        OpenAiChatModel chatModel = OpenAiChatModel.builder()
                ...
                .defaultOptions(OpenAiChatOptions.builder()
                        .model("gpt-4.1-mini")
                        .toolCallbacks(new SyncMcpToolCallbackProvider(sseMcpClient(),computerMcpClient(),stdioMcpClient_csdn(),stdioMcpClient_weixin()).getToolCallbacks())
                        .build()).build();
